...
⚠️ **Une nomenclature établie pour l'un ne vaut pas pour les autres.** C'est la raison de
...
⚠️ **`www.mouser.fr` et `www.mouser.com` renvoient un 403 sur le tunnel CONNECT du proxy
